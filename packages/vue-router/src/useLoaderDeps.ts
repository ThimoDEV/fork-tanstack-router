...
) => ComputedRef<UseLoaderDepsResult<TRouter, TId, TSelected>>
...
>(
...
): ComputedRef<UseLoaderDepsResult<TRouter, TFrom, TSelected>> {
  ...
  }) as ComputedRef<UseLoaderDepsResult<TRouter, TFrom, TSelected>>
}
