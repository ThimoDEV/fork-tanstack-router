...
describe('useSearch', () => {
  ...
  test('when there is one search params', () => {
    ...
    ).returns.toEqualTypeOf<ComputedRef<{ page?: number }>>()
    ...
    expectTypeOf(
      useSearch<
        ...
        number
      >,
    ).returns.toEqualTypeOf<ComputedRef<number>>()
  ...
  test('when there are multiple search params', () => {
    ...
    expectTypeOf(
      useSearch<DefaultRouter, '/invoices', false>,
    ).returns.toEqualTypeOf<ComputedRef<{ page?: number; detail?: string }>>()
  ...
  test('when there are overlapping search params', () => {
    ...
    expectTypeOf(
      ...
      ComputedRef<{ page?: number; detail?: 'detail' | 50 }>
    >()
  ...
  test('when the root has no search params but the index route does', () => {
    ...
    expectTypeOf(
      useSearch<DefaultRouter, '/invoices', false>,
    ).returns.toEqualTypeOf<ComputedRef<{ indexPage?: number }>>()
  ...
  test('when the root has search params but the index route does not', () => {
    ...
    expectTypeOf(
      useSearch<DefaultRouter, '/invoices', false>,
    ).returns.toEqualTypeOf<ComputedRef<{ rootPage?: number }>>()
  ...
  test('when the root has search params but the index does', () => {
    ...
    expectTypeOf(
      ...
      ComputedRef<{ indexPage?: number; rootPage?: number }>
    >()
  ...
  describe('shouldThrow', () => {
    ...
    test('return type is `{ page: number }` when shouldThrow = true', () => {
      ...
      expectTypeOf(search).toEqualTypeOf<ComputedRef<{ page: number }>>()
    })
    ...
    test('return type is `{page: number} | undefined` when shouldThrow = false', () => {
      ...
      expectTypeOf(search).toEqualTypeOf<
        ComputedRef<{ page: number } | undefined>
      >()
    })
  })
})
