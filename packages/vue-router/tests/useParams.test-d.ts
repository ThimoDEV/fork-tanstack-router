...
describe('useParams', () => {
  ...
  test('when there is one param', () => {
    ...
    ).returns.toEqualTypeOf<ComputedRef<{ invoiceId: string }>>()
  ...
  test('when there are multiple params', () => {
    ...
    expectTypeOf(
      useParams<DefaultRouter, '/invoices', false>,
    ).returns.toEqualTypeOf<ComputedRef<{ invoiceId?: string; postId?: string }>>()
  ...
  describe('shouldThrow', () => {
    ...
    test('return type is `{ id: string }` when shouldThrow = true', () => {
      ...
      expectTypeOf(params).toEqualTypeOf<ComputedRef<{ id: string }>>()
    })
    ...
    test('return type is `{page: string} | undefined` when shouldThrow = false', () => {
      ...
      expectTypeOf(params).toEqualTypeOf<ComputedRef<{ id: string } | undefined>>()
    })
  })
})
